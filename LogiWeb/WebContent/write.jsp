	...
	<div class = "container">
		...
		<form method="post" action="writeAction.jsp">
			<table class="table table-striped" style ="text-align: center; border: 1px solid #dddddd">
				<thead>
					<tr>
						<th colspan="2" style="background-color: #eeeee; text-align: center;">운반 물품 등록</th>

					</tr>
				</thead>
				<tbody>
					<tr>
						<td><input type="text" class="form-control" placeholder="물품 이름" name="bbsTitle" maxlength="50"></td>
					</tr>
					<tr>
						<td><textarea rows="10"  class="form-control" placeholder="물품 정보" name="bbsContent" maxlength="2048"></textarea></td>
					</tr>
				</tbody>
			</table>
